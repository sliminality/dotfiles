        ...
        if vid in persist.errors:
            ...
            if errors:
                ...
                if lineno in errors:
                    ...
                    # new stuff
                    view.show_popup('<style>html { background-color: #1C2328; margin: 0px; color: #839496; } body { background-color: #1C2328; margin: 5px; border: none; font-size: 13px; color: #839496; } div { margin: 0px; word-wrap:break-word; } a { color: #2aa198; } .error_line { color: #839496; margin: 4px 5px 4px; }</style> <div><p class="error_line">✘ ' + '</p><p class="error_line"> ✘ '.join(line_errors) + '</p></div>',
                                    location=-1,
                                    max_width=400)
                    # end new stuff
                else:
